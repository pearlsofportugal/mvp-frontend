...
import type { SiteConfigPreviewResponse } from './siteConfigPreviewResponse';

export interface ApiResponseSiteConfigPreviewResponse {
  /** Whether the request succeeded. */
  success: boolean;
  /** Response payload; present when success=True. */
  data?: SiteConfigPreviewResponse | null;
