 ...
 */
import type { ListingDetailReadEnrichedTranslations } from './listingDetailReadEnrichedTranslations';
...
export interface ListingDetailRead {
  ...
  enriched_translations?: ListingDetailReadEnrichedTranslations;
  id: string;
